...
def apostila(request, id):
    ...
    view_totais = ViewApostila.objects.filter(apostila=apostila).count()
    ...
    return render (request, 'apostila.html', {'apostila':apostila,'view_totais':view_totais, 'view_unica':view_unica})